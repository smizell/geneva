...
class Runtime {
  ...
  run(code) {
    ...
    // Functions can either be runners that wrap runtimes or they can
    // be actual functions. Runners allow us to pass around the runtime.
    if (fn instanceof Runner) {
      return fn.run(this, args);
    }

    // Functions allow for interacting with normal JavaScript code
    // This is mostly used by the lambda special form
